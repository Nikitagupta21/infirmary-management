			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text" name="address"
                        ...
                        <div class="form-group">
				<label for="birthDate" class="col-sm-3 control-label">Email
					</label>
				<div class="col-sm-9">
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="tel" name="contactNumber" placeholder="9521113802"
                        ...
                        <div class="form-group">
				<label for="birthDate" class="col-sm-3 control-label">Designation
					</label>
				<div class="col-sm-9">
					<input type="text" name="designation" class="form-control" required>
                        ...
                        <div class="form-group">
				<label for="birthDate" class="col-sm-3 control-label">date of joining
					</label>
				<div class="col-sm-9">
				...
				<div class="col-sm-9">
					<select id="userType" name="userType" class="form-control" required>
						...
						<option value="2">Doctor</option>
                                                ...
                                                <option value="4">Lab Person</option>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" name="specialization"
                         ...
                         <div class="form-group">
				<label for="birthDate" class="col-sm-3 control-label">Bank 
					Name</label>
				<div class="col-sm-9">
					<input type="text" name="bankname" class="form-control" required>
                        ...
                        <div class="form-group">
				<label for="birthDate" class="col-sm-3 control-label">Branch 
					</label>
				<div class="col-sm-9">
					<input type="text" name="branch" class="form-control" required>
                        ...
                        <div class="form-group">
				<label for="birthDate" class="col-sm-3 control-label">Salary 
					</label>
				<div class="col-sm-9">
					<input type="text" name="salary" class="form-control" required>
                        ...
                        <div class="form-group">
				<label for="birthDate" class="col-sm-3 control-label">account number
					</label>
				<div class="col-sm-9">
