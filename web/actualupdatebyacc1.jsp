...
<html>
            ...
            <td>First Name</td><td><input type="text" name="fname" Value="<%= rs.getString(2)%>"></td>
             ...
             <td>Last Name</td><td><input type="text" name="lname" value="<%= rs.getString(3)%>"></td></tr>
                   <tr> <td>userName</td><td><input type="text" name="userName" Value="<%= rs.getString(4)%>"></td>
                       <td>password</td><td><input type="password" name="password" Value="<%= rs.getString(5)%>" disabled></td>
            
            <tr><td>Date Of Birth<br>(YYYY-MM-DD)</td><td><input name="dob" value="<%= rs.getString(6)%>"></td>
            <td>token</td><td><input type="text" name="token" value="<%= rs.getString(7)%>" disabled></td></tr>
            <td>persontype</td><td><input type="text" name="personType" value="<%= rs.getString(8)%>" disabled></td></tr>
           <td>gender</td><td><input type="text" name="gender" value="<%= rs.getString(9)%>"></td></tr>
            <td>address</td><td><input type="text" name="address" value="<%= rs.getString(10)%>"></td></tr>
            ...
            <td>Designation</td><td><input type="text" name="designation" value="<%= rs.getString(13)%>"></td>
            <tr><td>Date Of Joining<br>(YYYY-MM-DD)</td><td><input type="date" name="doj" value="<%= rs.getDate(14)%>"></td></tr>
            <td>Bank Name</td><td><input type="text" name="bankname" value="<%= rs.getString(15)%>"  ></td>
             <tr><td>Branch Name</td><td><input type="text" name="branchname" value="<%= rs.getString(16)%>"></td>
            <td>Account No</td><td><input type="text" name="accno" value="<%= rs.getInt(17)%>"  ></td>
            <td></td><td></td></tr>
           
            
            <%--<input type="hidden" name="userName" value="<%= rs.getString(4)%>">--%>
            <td></td><td></td>
            <td></td><td></td></tr>
        <tr><td>Basic Salary</td><td><input type="text" name="bs" value="<%= rs.getFloat(18)%>"></td></tr>
 ...
 }else{ response.sendRedirect("updatebyacc1.jsp?userName=Please enter valid employeeid !!");
           }
      rs.close();
        ps.close();
        con.close();
