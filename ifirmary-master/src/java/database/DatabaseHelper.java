	...
	public void createPerson(HttpServletRequest request) {
		try {
			...
			ps = connection.prepareStatement(
					"insert into person(firstName,lastName,userName,password,dob,token,personType,gender,address,email,contactNumber,accNo,bankName,branch,designation,salary,doj) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
			...
			ps.setString(9, request.getParameter("address"));
                        ps.setString(10, request.getParameter("email"));
                            ps.setString(11, request.getParameter("contactNumber"));
			ps.setString(12, request.getParameter("accno"));
                        ps.setString(13, request.getParameter("bankname"));
                        ps.setString(14, request.getParameter("branch"));
                        ps.setString(15, request.getParameter("Designation"));
                        ps.setString(16, request.getParameter("salary"));
                        ps.setString(17, request.getParameter("doj"));
