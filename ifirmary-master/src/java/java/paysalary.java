...
"        <div class=\"well1\">");
          ...
          //  out.println("<br><h2><center><b>Employee List</b></center></h2><br><table border=\"1\" style=\"width:100%;border-spacing: 0.5em;text-align: center;\">");
           // out.println("<tr><td><b>Name</b></td><td><b>ID</b></td><td><b>DOB</b></td><td><b>PhoneNo</b></td><td><b>Designation</b></td><td><b>Basic Salary(Per Month)</b></td><td><b>Date Of Join</b></td></tr></b>");
            ...
            ps1.setInt(3,year);
            ps1.setInt(4,rs.getInt(18));
         
            ps1.setInt(5,tdays);
            int i,j;
                  PreparedStatement ps2=con.prepareStatement("INSERT INTO `leave1` VALUES (?,?,?,?,?,?)");
             ps2.setInt(1,3);
            ...
            ps2.setInt(5,year);
            ps2.setString(6,rs.getString(4));
  ...
  //      out.println(e);
    //        if(e.equals("MySQLIntegrityConstraintViolationException"))
               response.sendRedirect("paysalary.jsp?userName=Salary has been already allotted");     
            
       }
            }
            response.sendRedirect("paysalary.jsp?userName=Salary has been successfully paid to all employees");
