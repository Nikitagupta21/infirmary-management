 ...
 */
@WebServlet("/displayemployee1")
public class displayemployee1 extends HttpServlet {
 ...
 if(session.getAttribute("username")!=null)           
 {
           ...
           Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/medic","root","nikita");
            ...
            PreparedStatement ps = con.prepareStatement("SELECT * from person where designation!='p'");
...
"        </style></head><body>");
        ...
        out.println("<img src=\"health.jpg\"> <strong>Welcome "+session.getAttribute("username")+"</strong>");
...
"        <div class=\"well1\">");
            ...
            out.println("<tr><td><b>Name</b></td><td><b>UserName</b></td><td><b>PhoneNo</b></td><td><b>Designation</b></td><td><b>Basic Salary(Per Month)</b></td><td><b>Date Of Join</b></td></tr></b>");
            while(rs.next())
            {
             out.println("<tr><td>"+rs.getString(2)+" "+rs.getString(3)+"</td><td>"+rs.getString(4)+"</td><td>"+rs.getString(11)+"</td><td>"+rs.getString(13)+"</td>");
           
            out.println("<td>"+rs.getInt(18)+"</td>");
            out.println("<td>"+rs.getDate(14)+"</td></tr>");
