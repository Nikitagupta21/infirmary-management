...
<html>
  ...
  <li><a href="logout">Logout</a></li>
         ...
         <div class="well1">
               <% if(request.getParameter("userName")!=null)out.println("<ul style=\"list-style-type:disc;color:#2F9DD1; position: static;margin-left:20px;margin-top:20px;\"><li>"+request.getParameter("userName")+"</li></ul>"); %>
    <form method="post" action="validate1">
            <table style="margin-left:40px;">
               
                <tr>
                <td><h4>Enter Password</h4></td><td><input type="password" name="password" placeholder="Please Enter Password"/>
                </td>
            </tr>
