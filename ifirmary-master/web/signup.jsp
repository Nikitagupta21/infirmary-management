...
<body>
				...
				<div class="col-sm-9">
					<input type="text" name="address"
						...
						maxlength="40" required>
                             ...
                             <div class="form-group">
					<label for="Specialization" class="col-sm-3 control-label">email</label>
					<div class="col-sm-9">
				...
				<div class="col-sm-9">
					<select id="userType" name="userType" class="form-control" required>
						...
						<option value="2">Doctor</option>
                                                       ...
                                                       <option value="4">LabPerson</option>
					...
					<div class="col-sm-9">
						<input type="text" name="specialization"
							placeholder="Cardiologist" class="form-control">
                            	...
                            	<div class="form-group">
					<label for="Specialization" class="col-sm-3 control-label">Account Number</label>
					<div class="col-sm-9">
						<input type="text" name="accno"
                            ...
                            <div class="form-group">
					<label for="Specialization" class="col-sm-3 control-label">BankName</label>
					<div class="col-sm-9">
						<input type="text" name="bankname"
							 class="form-control">
                            	...
                            	<div class="form-group">
					<label for="Specialization" class="col-sm-3 control-label">Branch</label>
					<div class="col-sm-9">
						<input type="text" name="branch"
							 class="form-control">
                                        	...
                                        	<div class="form-group">
					<label for="Specialization" class="col-sm-3 control-label">Salary</label>
					<div class="col-sm-9">
						<input type="text" name="salary"
                            ...
                            <div class="form-group">
					<label for="Specialization" class="col-sm-3 control-label">Designation</label>
					<div class="col-sm-9">
  ...
  <div class="form-group">
					<label for="Specialization" class="col-sm-3 control-label">DOJ</label>
					<div class="col-sm-9">
