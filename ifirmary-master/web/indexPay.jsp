 ...
 select{        height:30px;
    ...
    <body>
        ...
        <table align="center" style="margin-left: 70px ;margin-top: 8px ;">
            <tr>
                <td colspan="2"><center style="color:#2F9DD1;"><% if(request.getParameter("userName")!=null)out.println("<span style=\"font-family:tahoma;\">"+request.getParameter("userName")+"</span>");%></center></td>
            </tr>
            <tr>
