...
<li><a href="about.jsp"  >About us</a></li>
  <li><a href="signup.jsp"  >Sign up</a></li>
    <li><a href="indexPay.jsp"  >Payroll</a></li>
<li><a href="labPerson.jsp" >laboratory</a></li>
  ...
  <div class="clear"> </div>
   ...
   <div class="ui  horizontal segments">
    ...
    <div class="ui  right aligned teal inverted segment">   
        ...
        <div class="user">
            <div class="ui icon">
                <i class="ui  large users icon"></i>Receptionist login
                <a  href="receptionist.jsp">
                    <button class="ui blue button">LOGIN</button>
                </a>
            </div>
        </div>
  ...
  <div class="Box-body p-6">
        <article class="markdown-body entry-content" itemprop="text"><h1>Infirmary Management System</h1>
<p>This is a Infirmary management user interface for managing, monitoring and controlling the system in a Hospital. This application is developed using java, which mainly focuses on basic operations in a hospital like adding new patient information, and updating new information, assigning the doctor for patient,generating pay-slip of all the employees and paying them salary,along with apply leave feature. It features a familiar and well thought-out, an attractive online user interface, combined with strong management capabilities. The backend of the project is designed using MySQL, Java and front end using HTML, CSS, and Bootstrap.</p>
</article>
</div>
