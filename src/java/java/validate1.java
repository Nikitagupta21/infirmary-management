...
String userName=(String) session.getAttribute("userName");          
   ...
   // System.out.println("1");
          PreparedStatement ps = con.prepareStatement("SELECT * from accountant WHERE userName=?");
...
//            session.setAttribute("usertype",usertype);
 ...
 rs.close();
         ...
         con.close();
                ...
                response.sendRedirect("paysalary.jsp?userName=Please enter correct password");
