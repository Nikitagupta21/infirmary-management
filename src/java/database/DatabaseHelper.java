	...
	public void createPerson(HttpServletRequest request) {
		try {
			...
			ps = connection.prepareStatement(
					"insert into person(firstName,lastName,userName,password,dob,token,personType,gender,address,contactNumber,email,designation,dateofjoin,bankname,branch,accno,salary) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
			...
			ps.setString(10, request.getParameter("contactNumber"));
                        ...
                        ps.setString(12, request.getParameter("designation"));
                        ps.setString(13, request.getParameter("doj"));
                        ps.setString(14, request.getParameter("bankname"));
                        ps.setString(15, request.getParameter("branch"));
                        ps.setString(16, request.getParameter("accno"));
                        ps.setString(17, request.getParameter("salary"));
